...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 300.0, 197.0, 44.0, 22.0 ],
					"text" : "t 1 l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 201.0, 119.0, 52.0, 22.0 ],
					"text" : "gate 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 343.0, 119.0, 59.0, 22.0 ],
					"text" : "f #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 267.0, 119.0, 59.0, 22.0 ],
					"text" : "i #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "bang", "" ],
					"patching_rect" : [ 234.0, 197.0, 55.0, 22.0 ],
					"text" : "t 1 b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 234.0, 158.0, 85.0, 22.0 ],
					"text" : "routepass 0 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 33.0, 153.0, 127.0 ],
					"text" : "this is so that we can have the [pattr] with @thru 1 & @parameter_enable 1 & @_initial_enable 0, and still have 0's passed through on load if [pattr] range includes a 0 (sorry ben, sorry jeremy, sorry rodrigo)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 171.0, 119.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 281.0, 156.0, 114.0 ],
					"text" : "(ultimately, [pattr] still behaves inconsistently, as it's output behaviour is different on loading a patch containing the abstraction, to changing the attributes on an already instantiated abstraction)"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 309.5, 228.421875, 188.2109375, 228.421875, 188.2109375, 109.0, 210.5, 109.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 243.5, 229.0, 187.96875, 229.0, 187.96875, 109.0, 210.5, 109.0 ],
					"source" : [ "obj-24", 0 ]
				}
