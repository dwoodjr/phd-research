...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 31.0, 486.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 120.0, 96.0, 700.928571428571558, 130.779177674313132 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 421.0, 160.0, 40.0, 22.0 ],
					"text" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 287.0, 71.0, 22.0 ],
					"text" : "quantize $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 216.0, 245.0, 63.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 142.0, 80.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 492.0, 637.0, 333.0, 77.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 4,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 492.0, 558.0, 333.0, 77.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 4,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 492.0, 637.0, 333.029862999999978, 77.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 492.0, 558.0, 332.928570999999977, 77.0 ],
					"reflectioncolor" : [ 1.0, 0.725490196078431, 0.003921568627451, 1.0 ],
					"ruler" : 0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 137.0, 461.0, 71.0, 35.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 326.0, 123.0, 35.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
,
					"patching_rect" : [ 317.0, 287.0, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 349.0, 468.0, 65.0, 22.0 ],
					"text" : "onebang 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 349.0, 423.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 349.0, 513.0, 22.0, 22.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 513.0, 31.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"bgfillcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 468.0, 90.25, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 461.0, 244.0, 53.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"patching_rect" : [ 120.0, 558.0, 61.0, 22.0 ],
					"text" : "p subKick"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 461.0, 332.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 195.0, 332.0, 172.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 423.0, 82.0, 22.0 ],
					"text" : "prepend jump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 195.0, 378.0, 139.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 519.0, 235.0, 68.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 195.0, 558.0, 285.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 195.0, 603.0, 45.0, 45.0 ]
				}
...
,
					"patching_rect" : [ 492.0, 558.0, 87.0, 22.0 ],
					"text" : "p jumpPosition"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 558.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 594.0, 244.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 63.0, 119.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
							"expression" : "themecolor.lesson_step_circle"
...
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 357.5, 361.972922170490108, 183.0, 361.972922170490108, 183.0, 275.88958883715668, 326.5, 275.88958883715668 ],
					"source" : [ "obj-123", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 204.5, 371.181255503823479, 129.5, 371.181255503823479 ],
					"order" : 1,
					"source" : [ "obj-123", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 326.5, 319.931255503823422, 204.5, 319.931255503823422 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 398.5, 410.722922170490108, 569.5, 410.722922170490108 ],
					"order" : 0,
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 398.5, 545.722922170490051, 204.5, 545.722922170490051 ],
					"order" : 1,
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 204.5, 415.722922170490108, 501.5, 415.722922170490108 ],
					"order" : 0,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"hidden" : 1,
					"midpoints" : [ 204.5, 415.097922170490108, 358.5, 415.097922170490108 ],
					"order" : 1,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 1 ],
					"hidden" : 1,
					"midpoints" : [ 293.5, 545.347922170490051, 569.5, 545.347922170490051 ],
					"order" : 0,
					"source" : [ "obj-213", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-98", 0 ],
					"midpoints" : [ 293.5, 545.347922170490051, 204.5, 545.347922170490051 ],
					"order" : 1,
					"source" : [ "obj-213", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 204.5, 455.181255503823422, 297.75, 455.181255503823422 ],
					"order" : 0,
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-98", 0 ],
					"hidden" : 1,
					"midpoints" : [ 358.5, 545.347922170490051, 204.5, 545.347922170490051 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-123", 0 ],
					"midpoints" : [ 247.5, 319.931255503823422, 204.5, 319.931255503823422 ],
					"source" : [ "obj-70", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-36::obj-8" : [ "live.tab[10]", "live.tab", 0 ],
			"obj-36::obj-9" : [ "live.tab[11]", "live.tab", 0 ],
			"obj-36::obj-92" : [ "live.tab[7]", "live.tab", 0 ],
			"obj-36::obj-94" : [ "live.tab[9]", "live.tab", 0 ],
