...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 23.0, 499.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 656.0, 175.0, 49.0, 22.0 ],
					"text" : "floor $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 601.0, 175.0, 63.0, 22.0 ],
					"text" : "lockout $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 175.0, 77.0, 22.0 ],
					"text" : "sensitivity $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 557.0, 73.0, 135.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 656.0, 104.0, 47.0, 51.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 601.0, 104.0, 47.0, 51.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 546.0, 104.0, 47.0, 51.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.0, 95.0, 169.0, 66.0 ],
					"proportion" : 0.5,
					"saved_attribute_attributes" : 					{
						"bgfillcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 445.0, 269.0, 59.0, 22.0 ],
					"text" : "gate~ 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 872.0, 269.0, 76.0, 22.0 ],
					"text" : "s stopDrums"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "stop" ],
					"patching_rect" : [ 1225.0, 316.0, 38.0, 22.0 ],
					"text" : "t stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1225.0, 269.0, 34.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1131.0, 269.0, 59.0, 22.0 ],
					"text" : "gate~ 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 788.0, 269.0, 59.0, 22.0 ],
					"text" : "gate~ 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 269.0, 80.0, 22.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 445.0, 222.0, 53.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 788.0, 222.0, 53.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_initial" : [ 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1131.0, 222.0, 53.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_initial" : [ 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 102.0, 222.0, 53.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_initial" : [ 1.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 216.0, 31.0, 372.0, 87.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "jump and pitch messages to dk.sampler~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 47.0, 182.0, 122.0, 22.0 ],
...
, 							{
								"box" : 								{
									"comment" : "jump and pitch messages to dk.sampler~",
									"id" : "obj-42",
									"index" : 1,
									"maxclass" : "outlet",
									"numinlets" : 1,
...
,
					"patching_rect" : [ 1131.0, 316.0, 81.0, 22.0 ],
					"text" : "p guitarDrone"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 532.0, 222.0, 81.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1168.0, 556.0, 285.0, 22.0 ],
					"text" : "dk.convolver~ rev_spring_large_bright.wav @gain 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1131.0, 603.0, 45.0, 45.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@voices", 2, "@timestretch", 1, "@timestretchmode", "extremestretch", "@speed", 12.5, "@gain", 50 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1131.0, 362.0, 322.0, 169.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 788.0, 556.0, 116.0, 22.0 ],
...
,
					"patching_rect" : [ 998.0, 316.0, 88.0, 22.0 ],
					"text" : "p loadSamples"
				}
...
, 							{
								"box" : 								{
									...
									"text" : "dk.sequencedata~ @sequence 56 53 56 53 52 53 61 66 64 68 56 55 56 58 40 61 60 55"
								}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 73.0, 332.291083091590167, 122.0, 33.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 74.5, 207.291083091590167, 126.0, 22.0 ],
													"text" : "random @range -2. 2."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 41.0, 249.291083091590167, 52.5, 22.0 ],
													"text" : "+ 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 41.0, 292.291083091590167, 89.0, 22.0 ],
													"text" : "prepend speed"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 41.0, 334.291083091590167, 30.0, 30.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"text" : "dk.filter @filter centroid > 105"
								}
...
,
					"patching_rect" : [ 102.0, 316.0, 140.0, 22.0 ],
...
,
					"patching_rect" : [ 788.0, 316.0, 127.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 641.0, 29.0, 234.0, 60.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-143", 0 ],
									"midpoints" : [ 170.5, 72.818181818181671, 503.5, 72.818181818181671 ],
									"order" : 0,
									"source" : [ "obj-175", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-12", 0 ],
									"midpoints" : [ 296.5, 116.886363636363541, 337.5, 116.886363636363541 ],
									"order" : 0,
									"source" : [ "obj-21", 1 ]
								}
...
,
					"patching_rect" : [ 445.0, 316.0, 57.0, 22.0 ],
					"text" : "p scratch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 788.0, 603.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 788.0, 362.0, 322.0, 169.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 445.0, 362.0, 322.0, 169.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 275.0, 316.0, 88.0, 22.0 ],
					"text" : "p loadSamples"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 556.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 102.0, 362.0, 322.0, 169.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "signal", "signal" ],
					"patching_rect" : [ 163.0, 222.0, 174.0, 22.0 ],
					"text" : "dk.descriptors~ @sensitivity 40"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 222.0, 45.0, 45.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@source", "BrushesExample_DPA_SP.wav" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"patching_rect" : [ 163.0, 107.0, 343.0, 90.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 232.5, 349.631478172522918, 454.5, 349.631478172522918 ],
					"source" : [ "obj-179", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-73", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1007.5, 349.631478172522918, 797.5, 349.631478172522918 ],
					"source" : [ "obj-183", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 275.833333333333314, 255.877159390840973, 837.5, 255.877159390840973 ],
					"order" : 1,
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 275.833333333333314, 255.877159390840973, 1180.5, 255.877159390840973 ],
					"order" : 0,
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 275.833333333333314, 255.877159390840973, 494.5, 255.877159390840973 ],
					"order" : 2,
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-59", 0 ],
					"hidden" : 1,
					"midpoints" : [ 284.5, 349.631478172522918, 454.5, 349.631478172522918 ],
					"order" : 1,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-67", 0 ],
					"hidden" : 1,
					"midpoints" : [ 284.5, 356.631478172522918, 111.5, 356.631478172522918 ],
					"order" : 0,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-62", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1140.5, 256.0, 1234.5, 256.0 ],
					"order" : 0,
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 555.5, 209.0, 172.5, 209.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 1,
					"midpoints" : [ 797.5, 256.0, 881.5, 256.0 ],
					"order" : 0,
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 454.5, 542.754318781681945, 137.5, 542.754318781681945 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 610.5, 209.0, 172.5, 209.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-76", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1234.5, 349.254318781681945, 1140.5, 349.254318781681945 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 172.5, 209.0, 72.5, 209.0 ],
					"order" : 1,
					"source" : [ "obj-68", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 172.5, 209.0, 46.5, 209.0 ],
					"order" : 2,
					"source" : [ "obj-68", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 665.5, 209.0, 172.5, 209.0 ],
					"source" : [ "obj-9", 0 ]
				}
		...
		"parameters" : 		{
			...
			"obj-68::obj-43" : [ "live.gain~[1]", "live.gain~[1]", 0 ],
