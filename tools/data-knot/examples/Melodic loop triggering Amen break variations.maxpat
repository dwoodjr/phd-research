...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 21.0, 486.0, 47.0 ],
...
,
					"text" : "In this example a generative breakbeat is being created based by using a list of available tempo subdivisions as additional triggers, creating a complex set of rhythms whenever an attack is detected."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 111.0, 60.0, 40.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 154.0, 313.0, 60.0, 60.0 ],
					"range" : [ -0.1, 1.1 ],
					"samples" : 88200.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.0, 378.0, 86.0, 69.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 258.0, 250.0, 150.0, 35.0 ],
...
,
					"patching_rect" : [ 418.0, 268.0, 88.0, 22.0 ],
					"text" : "p loadSamples"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 219.0, 508.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 219.0, 313.0, 322.0, 169.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 92.0, 202.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 152.0, 202.0, 152.0, 22.0 ],
					"text" : "dk.onset~ @sensitivity 100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 502.0, 244.0, 104.0, 55.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.theme_textcolor"
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 41.0, 88.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 543.0, 217.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"saved_attribute_attributes" : 					{
						"bgcolor" : 						{
							"expression" : "themecolor.lesson_step_circle"
...
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 228.0, 236.3125, 267.5, 236.3125 ],
					"order" : 0,
					"source" : [ "obj-108", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 228.0, 237.25, 163.5, 237.25 ],
					"order" : 1,
					"source" : [ "obj-108", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 267.5, 298.875, 163.5, 298.875 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-67", 0 ],
					"midpoints" : [ 267.5, 298.875, 228.5, 298.875 ],
					"order" : 1,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-67", 0 ],
					"hidden" : 1,
					"midpoints" : [ 427.5, 299.4375, 228.5, 299.4375 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 531.5, 494.5625, 254.5, 494.5625 ],
					"source" : [ "obj-67", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 101.5, 188.4375, 161.5, 188.4375 ],
					"order" : 0,
					"source" : [ "obj-68", 0 ]
				}
